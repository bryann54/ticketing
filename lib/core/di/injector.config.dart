...
import '../api_client/client/client/api_client.dart' as _i107;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i174.GetIt> init({
    ...
    gh.lazySingleton<_i107.ApiClient>(
        () => _i107.ApiClient(gh<String>(instanceName: 'BaseUrl')));
    ...
    gh.lazySingleton<_i910.VenuesRemoteDatasource>(
        () => _i910.VenuesRemoteDatasource(gh<_i107.ApiClient>()));
    gh.lazySingleton<_i65.ShowsRemoteDatasource>(
        () => _i65.ShowsRemoteDatasource(gh<_i107.ApiClient>()));
